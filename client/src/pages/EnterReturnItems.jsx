...
export const EnterReturnItems = () => {
  ...
  return (
    <div className="p-8 w-3/4 mx-auto me-0 pt-4">
       ...
       <h1 className="text-3xl font-bold mb-6">Enter Return Items</h1>
      ...
      <form className="mb-80 mt-20 pb-4 pt-5 " onSubmit={handleSubmit}>
        ...
        <select
          ...
          className="block mb-4 px-11 py-4 border border-blue-500 rounded-md focus:outline-none focus:border-blue-500"
        ...
        <div className="flex justify-between">
          ...
          <button type="button" className="bg-red-500 text-white px-4 py-2 rounded-md focus:outline-none focus:bg-red-600">
            Cancel
          </button>
        </div>
      </form>
