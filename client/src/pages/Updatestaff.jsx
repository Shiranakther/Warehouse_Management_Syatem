...
<div className='p-3 max-w-lg mx-auto w-4/5 mr-96'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input type="text" placeholder='Name' id='name' className={`bg-slate-100 p-3 rounded-lg border-2 border-zinc-400 ${formData.username ? 'cursor-not-allowed opacity-50' : ''}`} value={formData.name || ''} onChange={handleChange} required disabled />
