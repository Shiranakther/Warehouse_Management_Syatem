...
export const addLostItem = async (req, res) => {
    ...
    try {
        ...
        // Retrieve the system item from the database
        const systemItem = await Item.findOne({ ItemID: itemId });

        // If system item not found, default systemQuantity to 0
        const systemQuantity = systemItem ? systemItem.ItemNoOfUints : 0;
